...
if subjectindex == "1":
    ...
    result = firebaseref.get(standard1+"assignmentsubject/"+sanskrit,'')
    dict_items = result.items()
    firstelement = list(dict_items)[:1]
    firstelementindex = int(firstelement[0][0])-1
    firstelementindex = str(firstelementindex)
    result = firebaseref.post(standard1+'assignmentsubject/'+sanskrit+firstelementindex, data)
    firebaseref.put(standard1+'assignmentsubject/'+sanskrit+firstelementindex,'date',d1)
    firebaseref.put(standard1+'assignmentsubject/'+sanskrit+firstelementindex,'status',statusvar)
    firebaseref.put(standard1+'assignmentsubject/'+sanskrit+firstelementindex,'subject',subjectvar)
    stringdelete = result["name"]
    firebaseref.delete(standard1+'assignmentsubject/'+sanskrit+firstelementindex, stringdelete) 
    
elif subjectindex == "7":
    result = firebaseref.get(standard1+"assignmentsubject/"+hindi,'')
    dict_items = result.items()
    firstelement = list(dict_items)[:1]
    firstelementindex = int(firstelement[0][0])-1
    firstelementindex = str(firstelementindex)
    result = firebaseref.post(standard1+'assignmentsubject/'+hindi+firstelementindex, data)
    firebaseref.put(standard1+'assignmentsubject/'+hindi+firstelementindex,'date',d1)
    firebaseref.put(standard1+'assignmentsubject/'+hindi+firstelementindex,'status',statusvar)
    firebaseref.put(standard1+'assignmentsubject/'+hindi+firstelementindex,'subject',subjectvar)
    stringdelete = result["name"]
    firebaseref.delete(standard1+'assignmentsubject/'+hindi+firstelementindex, stringdelete) 
