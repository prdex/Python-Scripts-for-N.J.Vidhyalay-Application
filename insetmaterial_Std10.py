...
for x in range(2):
    if subjectindex == "1":
        ...
        firebaseref.put(standard1+'materiallink/'+gujarati+firstelementindex,'downloadlink','testabc')
        firebaseref.put(standard1+'materiallink/'+gujarati+firstelementindex,'name','abcname')
        stringdelete = result["name"]
